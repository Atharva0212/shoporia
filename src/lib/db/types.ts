...
import { pendingUserModelName, PendingUserSchema } from "./models/pendingUser.model";
...
export type DbModels={
    [pendingUserModelName]:Store<typeof pendingUserModelName,typeof PendingUserSchema>&{document:UserDocument},
